<template>
  ...
  <div id="main-part">
    <HorizontalNavBar stateProp="home"/>
      ...
      <div class="top-bar">
        ...
        <table class="table table-striped mt-3">
          ...
          <tr v-for="session in sessions" :key="session.id">
            <td>{{ session.name }}</td>
            <td>
              <button @click="openSession(session)" class="btn btn-primary">Open</button>
            </td>
            <td>
              <button @click="deleteSession(session)" class="btn btn-primary">Delete</button>
            </td>
          </tr>
          </tbody>
        </table>
